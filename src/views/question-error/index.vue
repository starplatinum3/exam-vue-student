    ...
    <el-row :gutter="50">
      <el-col :span="14">
        <el-table v-loading="listLoading" :data="tableData" fit highlight-current-row style="width: 100%" @row-click="itemSelect">
          <el-table-column  sortable prop="shortTitle" label="题干"  show-overflow-tooltip />
          <el-table-column  sortable prop="questionType" label="题型"  
          :formatter="questionTypeFormatter" width="100" />
          <!-- width="70" -->
          <!-- width="70" -->
