<template>
  <div class="lowin  lowin-blue">
    <div class="lowin-brand">
      ...
      <img src="@/assets/miku.jpg" alt="logo" style="margin-top: 12px">
    </div>
  ...
  methods: {
    ...
    getAllURL(){
      ...
      allApi.getAllURL().then(response => {
        console.log("response getAllURL")
    ...
    setUserInfoOMaiE(){
      ...
      console.log( this.$store.state );
         console.log(" _this.$store.state alyout  userInfo" );
        ...
        if (valid) {
          ...
          loginApi.login(this.loginForm).then(function (result) {
            if (result && result.code === 1) {
              console.log("_this.loginForm  loginApi.login se setUserInfo");
              console.log(_this.loginForm);
              // _this.setUserName(_this.loginForm.userName)
              // _this.setUserInfo(_this.loginForm)
              //               _this.setUserInfo({
              //                 name:"你小子"
              //               })
              // setUserInfo
